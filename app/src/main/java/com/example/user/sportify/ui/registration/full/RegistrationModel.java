...
public class RegistrationModel {
    ...
    public void signUp(SingCallback callback, String name, String age, String phone, String password) {
    ...
    private Call<BaseServerAnswer<DataUserToken>> callBaseDataUserTokenApi(String name, String age, String phone, String password) {
    ...
    class SignUpTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            callBaseDataUserTokenApi(name, age, phone, password).enqueue(new Callback<BaseServerAnswer<DataUserToken>>() {
                @Override
                public void onResponse(@NonNull Call<BaseServerAnswer<DataUserToken>> call, @NonNull Response<BaseServerAnswer<DataUserToken>> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<BaseServerAnswer<DataUserToken>> call, @NonNull Throwable t) {
    ...
    class ProfileTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            callBaseDataProfileApi(token).enqueue(new Callback<BaseServerAnswer<ProfileData>>() {
                @Override
                public void onResponse(@NonNull Call<BaseServerAnswer<ProfileData>> call, @NonNull Response<BaseServerAnswer<ProfileData>> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<BaseServerAnswer<ProfileData>> call, @NonNull Throwable t) {
    ...
    class TryToSignIn extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            callBaseSingInApi(phone, password).enqueue(new Callback<BaseServerAnswer<DataUserToken>>() {
                @Override
                public void onResponse(@NonNull Call<BaseServerAnswer<DataUserToken>> call, @NonNull Response<BaseServerAnswer<DataUserToken>> response) {
                    if (response.isSuccessful()) {
                        String token = fetchDataUserTokenResults(response).getToken();
                        if (token != null)
                            callback.onSendToken(token);
                        else callback.onSendToken(AUTH_ERROR);
