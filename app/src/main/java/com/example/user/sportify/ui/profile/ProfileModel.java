...
public class ProfileModel {
    ...
    public void updateProfile(UpdateProfileCallback callback, String token, String name, String phone, String password) {
        UpdateProfileTask updateProfileTask = new UpdateProfileTask(callback, token, name, phone, password);
        updateProfileTask.execute();
    }


    private Call<ResponseBody> callUpdateProfile(String token, String name, String phone, String password) {
    ...
    class UpdateProfileTask extends AsyncTask<Void, Void, Void> {
        ...
        UpdateProfileTask(UpdateProfileCallback callback, String token, String name, String phone, String password) {
            this.token = token;
            this.name = name;
            this.phone = phone;
