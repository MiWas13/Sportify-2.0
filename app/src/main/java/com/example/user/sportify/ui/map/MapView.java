...
public interface MapView extends MvpView {
    void addPoints(ArrayList<ArrayList<String>> coordinates, List<GameDataApi> games, ArrayList<Integer> icons);
    ...
    void initGameDescription(LinearLayoutManager gamesLayoutManager, ConcretGameDescriptionAdapter concretGameDescriptionAdapter);
    void setGameInfo();
    void showBottomSlider();
    void initGame();
    void setBaseInfo(GameDataApi game, String categoryName, String date);
    void initOrganizerGameDescription(LinearLayoutManager concretGameDescriptionLayoutManager, ConcretGameDescriptionAdapter concretGameDescriptionAdapter);
    void initOrganizerGame();
    void addParticipant(UserParticipantData user);
    void initParticipantsPhones(LinearLayoutManager participantsPhonesLayoutManager, OrganizerConcretGameParticipantsAdapter organizerConcretGameParticipantsAdapter);
